-- ---------------------------------------------------------------------------
-- Justificativa passa a ser obrigatória pra concluir uma atividade "enquete"
-- — mesma trava que já existia pra resposta/anexos mínimos, tanto no client
-- (checklists.tsx: justificativaPendente) quanto aqui no trigger (defesa em
-- profundidade). Recria checklist_items_restrict_funcionario_update() a
-- partir da versão vigente (20260908160000_cargos_permissoes.sql), só
-- acrescentando a checagem de justificativa junto da de resposta.
-- ---------------------------------------------------------------------------
